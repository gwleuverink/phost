    ...
    >
        ...
        <div class="relative flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4">
            <div
                x-dialog:panel
                x-transition.in.out
                class="relative w-full max-w-3xl overflow-hidden rounded-t-xl bg-white shadow-lg sm:rounded-b-xl"
            >
                ...
                <div class="absolute right-0 top-0 pr-4 pt-4">
                    <button
                        ...
                        class="cursor-default rounded-lg bg-gray-50 p-1 text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:ring-offset-2"
                    >
