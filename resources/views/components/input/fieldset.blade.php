...
<fieldset @class([
    ...
    <legend class="absolute -top-2.5 left-2 inline-block select-none bg-white px-1 text-sm font-medium text-gray-700 dark:bg-neutral-950 dark:text-neutral-300">
        {{ $legend }}
    </legend>
